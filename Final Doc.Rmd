...
pca_result_coincident <- princomp(pca_data_coincident)
...
values_coincident %>% 
  ...
  annotate("rect", xmin = as.Date("2020/02/01"), xmax = as.Date("2020/04/01"), ymin = -500000, ymax = 750000, alpha = .2, fill = 'purple') +
  annotate("rect", xmin = as.Date("2007/12/01"), xmax = as.Date("2009/06/01"), ymin = -500000, ymax = 750000, alpha = .2, fill = 'purple') +
  annotate("rect", xmin = as.Date("2001/03/01"), xmax = as.Date("2001/11/01"), ymin = -500000, ymax = 750000, alpha = .2, fill = 'purple') +
  annotate("rect", xmin = as.Date("1990/07/01"), xmax = as.Date("1991/03/01"), ymin = -500000, ymax = 750000, alpha = .2, fill = 'purple')+
  annotate("rect", xmin = as.Date("1981/07/01"), xmax = as.Date("1982/11/01"), ymin = -500000, ymax = 750000, alpha = .2, fill = 'purple')+
  annotate("rect", xmin = as.Date("1980/01/01"), xmax = as.Date("1980/07/01"), ymin = -500000, ymax = 750000, alpha = .2, fill = 'purple')+
  annotate("rect", xmin = as.Date("1973/11/01"), xmax = as.Date("1975/05/01"), ymin = -500000, ymax = 750000, alpha = .2, fill = 'purple')
...
pca_result_lagging <- princomp(pca_data_lagging)
...
values_lagging %>% 
  ...
  annotate("rect", xmin = as.Date("2020/02/01"), xmax = as.Date("2020/04/01"), ymin = -7500, ymax = 10000, alpha = .2, fill = 'purple') +
  annotate("rect", xmin = as.Date("2007/12/01"), xmax = as.Date("2009/06/01"), ymin = -7500, ymax = 10000, alpha = .2, fill = 'purple') +
  annotate("rect", xmin = as.Date("2001/03/01"), xmax = as.Date("2001/11/01"), ymin = -7500, ymax = 10000, alpha = .2, fill = 'purple') +
  annotate("rect", xmin = as.Date("1990/07/01"), xmax = as.Date("1991/03/01"), ymin = -7500, ymax = 10000, alpha = .2, fill = 'purple')+
  annotate("rect", xmin = as.Date("1981/07/01"), xmax = as.Date("1982/11/01"), ymin = -7500, ymax = 10000, alpha = .2, fill = 'purple')+
  annotate("rect", xmin = as.Date("1980/01/01"), xmax = as.Date("1980/07/01"), ymin = -7500, ymax = 10000, alpha = .2, fill = 'purple')+
  annotate("rect", xmin = as.Date("1973/11/01"), xmax = as.Date("1975/05/01"), ymin = -7500, ymax = 10000, alpha = .2, fill = 'purple')
```
