...
# Important checks
correlations <- cor(pca_data_coincident_standardized)
print(correlations)
# Calculate the Kaiser-Meyer-Olkin (KMO) measure for the dataset
kmo <- KMO(pca_data_coincident_standardized)
print(kmo)
...
# Important checks
correlations <- cor(pca_data_lagging_standardized)
print(correlations)
# Calculate the Kaiser-Meyer-Olkin (KMO) measure for the dataset
kmo <- KMO(pca_data_lagging_standardized)
print(kmo)
