...
## Real GDP growth TODO: needs to be interpolated and added to final df
```{r}
...
#TODO add csv invtosales
inv_to_sales <- read_csv("~/Desktop/masterThesis/investmentfound/invtosales.csv", col_types = cols(Date = col_date(format = "%Y-%m-%d")))
```
...
#Trade weighted dollar index TODO change to first of the month
...
dataAllPctChange <- dataAllInterpolated %>% 
  ...
  mutate(YOYCoreCPI_pct_change = (YOYCoreCPI/lag(YOYCoreCPI) - 1)) %>% # TODO remove, because percent of percentx
