...
## All-Transactions House Price Index for the United States ##TODO interpolate
```{r}
...
retail_trade <- tq_get("",
  ...
  Quandl("FRED/USTRADE", start_date=SDate,end_date=EDate, collapse = "monthly") %>% 
...
outstanding_loans <- tq_get("TOTLL", 
  ...
  Quandl("FRED/TOTLL", start_date=SFDate, end_date=EFDate, collapse = "monthly") %>% 
