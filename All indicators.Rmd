...
yield_curve <- Quandl("USTREASURY/HQMYC", start_date=SFDate, end_date=EFDate,type="xts", collapse = "daily")
...
## Employment - avgDurationUne & UnitLaborCosts
```{r}
#Labor Force
Employment <- NULL
...
## Inflation - core_CPI
```{r}
core_CPI <- Quandl("FRED/CPILFESL", start_date=SFDate, end_date=EFDate ,type="xts", collapse = "monthly")

CPI <- Quandl("FRED/CPIAUCSL", start_date=SFDate, end_date=EFDate ,type="xts", collapse = "monthly")
...
consumer_debt_to_income <- Quandl("FRED/TDSP", start_date=SFDate, end_date=EFDate ,type="xts", collapse = "quarterly")
...
```{r}
#outstanding loans
outstanding_loans <- Quandl("FRED/TOTLL", start_date=SFDate, end_date=EFDate ,type="xts", collapse = "weekly")
...
plot(x=dollar_index$date, y=dollar_index$adjusted)
```
